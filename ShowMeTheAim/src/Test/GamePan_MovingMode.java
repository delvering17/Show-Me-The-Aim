...
public class GamePan_MovingMode extends JPanel {
	...
	GamePan_MovingMode(GameMainFrame gameMainFrame) {
	...
	void gamePan_point_show() {
		...
		switch (gameStart_MovingMode.point/100) {
		...
		switch ((gameStart_MovingMode.point%100)/10) {
		...
		switch ((gameStart_MovingMode.point%10)) {
	...
	void gamePan_life_show() {
		...
		switch (gameStart_MovingMode.life/100) {
		...
		switch ((gameStart_MovingMode.life%100)/10) {
		...
		switch ((gameStart_MovingMode.life%10)) {
